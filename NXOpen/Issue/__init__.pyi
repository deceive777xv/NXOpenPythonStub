...
class SnapshotWorksetBuilder(Builder):
    ...
    @property
    def ImpactedSubset(self) -> Issue.SnapshotSubsetBuilder: ...
    @ImpactedSubset.setter
    def ImpactedSubset(self, value: Issue.SnapshotSubsetBuilder) -> None: ...
    @property
    def ProblemSubset(self) -> Issue.SnapshotSubsetBuilder: ...
    @ProblemSubset.setter
    def ProblemSubset(self, value: Issue.SnapshotSubsetBuilder) -> None: ...
    @property
    def ReferenceSubset(self) -> Issue.SnapshotSubsetBuilder: ...
    @ReferenceSubset.setter
    def ReferenceSubset(self, value: Issue.SnapshotSubsetBuilder) -> None: ...


class SnapshotSubsetBuilder(Builder):
    def __init__(self) -> None: ...
    @property
    def Context(self) -> Issue.SnapshotSubsetBuilder.ContextType: ...
    @Context.setter
    def Context(self, value: Issue.SnapshotSubsetBuilder.ContextType) -> None: ...
    @property
    def SelectParts(self) -> Assemblies.SelectComponentList: ...
    @SelectParts.setter
    def SelectParts(self, value: Assemblies.SelectComponentList) -> None: ...
...
class IssueProperty(NXObject):
    ...
    @property
    def ValueType(self) -> Issue.IssueProperty.Type: ...
    @ValueType.setter
    def ValueType(self, value: Issue.IssueProperty.Type) -> None: ...
...
class IssueManager(Utilities.NXRemotableObject):
    ...
    @property
    def IssueListCollection(self) -> Issue.IssueListCollection: ...
    @IssueListCollection.setter
    def IssueListCollection(self, value: Issue.IssueListCollection) -> None: ...
    @property
    def CurrentMode(self) -> Issue.IssueManager.Mode: ...
    @CurrentMode.setter
    def CurrentMode(self, value: Issue.IssueManager.Mode) -> None: ...
    @property
    def CurrentSite(self) -> Issue.IssueSite: ...
    @CurrentSite.setter
    def CurrentSite(self, value: Issue.IssueSite) -> None: ...
...
class IssueFolder(NXObject):
    ...
    @property
    def FolderType(self) -> Issue.IssueFolder.Type: ...
    @FolderType.setter
    def FolderType(self, value: Issue.IssueFolder.Type) -> None: ...
...
class IssueContentBuilder(Builder):
    ...
    @AssignedUser.setter
    def AssignedUser(self, value: str) -> None: ...
    @property
...
class IssueContent(NXObject):
    ...
    @IssueId.setter
    def IssueId(self, value: str) -> None: ...
    @property
    def PreviewImage(self) -> Issue.IssueAttachment: ...
    @PreviewImage.setter
    def PreviewImage(self, value: Issue.IssueAttachment) -> None: ...
    @property
    def Priority(self) -> str: ...
    @Priority.setter
    def Priority(self, value: str) -> None: ...
...
class IssueAttachment(NXObject):
    ...
    @property
    def AttachmentType(self) -> Issue.IssueAttachment.Type: ...
    @AttachmentType.setter
    def AttachmentType(self, value: Issue.IssueAttachment.Type) -> None: ...
    @property
    def ReferencedAttachmentId(self) -> str: ...
    @ReferencedAttachmentId.setter
    def ReferencedAttachmentId(self, value: str) -> None: ...
