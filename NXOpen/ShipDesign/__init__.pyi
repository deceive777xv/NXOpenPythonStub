...
class ShipSession(Utilities.NXRemotableObject):
    ...
    @property
    def Navigators(self) -> ShipDesign.NavigatorCollection: ...
    @Navigators.setter
    def Navigators(self, value: ShipDesign.NavigatorCollection) -> None: ...
    @property
    def Generator(self) -> ShipDesign.Generator: ...
    @Generator.setter
    def Generator(self, value: ShipDesign.Generator) -> None: ...
    @property
    def GeneralArrangement(self) -> ShipDesign.GeneralArrangementManager: ...
    @GeneralArrangement.setter
    def GeneralArrangement(self, value: ShipDesign.GeneralArrangementManager) -> None: ...
    @property
    def ApplicationUtils(self) -> ShipDesign.ApplicationUtils: ...
    @ApplicationUtils.setter
    def ApplicationUtils(self, value: ShipDesign.ApplicationUtils) -> None: ...
...
class ShipNavigatorNodeBuilder(Builder):
    ...
    def ExpandChildNodes(self, value: bool) -> None: ...
    @property
    def NodeName(self) -> str: ...
    @NodeName.setter
    def NodeName(self, value: str) -> None: ...
    @property
    def NodeType(self) -> ShipDesign.ShipNavigatorNodeBuilder.NodeTypes: ...
    @NodeType.setter
    def NodeType(self, value: ShipDesign.ShipNavigatorNodeBuilder.NodeTypes) -> None: ...
    @property
    def SourceFeatures(self) -> Features.SelectFeatureList: ...
    @SourceFeatures.setter
    def SourceFeatures(self, value: Features.SelectFeatureList) -> None: ...
    @property
    def SourceParts(self) -> Assemblies.SelectComponentList: ...
    @SourceParts.setter
    def SourceParts(self, value: Assemblies.SelectComponentList) -> None: ...
...
class NavigatorNode(NXObject):
    ...
    @CheckStatus.setter
    def CheckStatus(self, value: bool) -> None: ...
    @property
