...
class AppearanceEditTexture(Builder):
    def __init__(self) -> None: ...
    @property
    def AnchorType(self) -> Appearance.AppearanceEditTexture.AnchorTypes: ...
    @AnchorType.setter
    def AnchorType(self, value: Appearance.AppearanceEditTexture.AnchorTypes) -> None: ...
    @property
    ...
    def MappingProjection(self, value: int) -> None: ...
    @property
    ...
    def StudioMaterialName(self, value: str) -> None: ...
    @property
    def TextureNormalVector(self) -> Direction: ...
    @TextureNormalVector.setter
    def TextureNormalVector(self, value: Direction) -> None: ...
    @property
    def TextureOrigin(self) -> Point: ...
    @TextureOrigin.setter
    def TextureOrigin(self, value: Point) -> None: ...
    @property
    def TextureUpVector(self) -> Direction: ...
    @TextureUpVector.setter
    def TextureUpVector(self, value: Direction) -> None: ...
...
class AppearanceDesignatorBuilder(Builder):
    ...
    def DesignatorDescription(self, value: str) -> None: ...
    @property
    def DesignatorName(self) -> str: ...
    @DesignatorName.setter
    def DesignatorName(self, value: str) -> None: ...
    @property
    def ParentAppearanceArea(self) -> str: ...
    @ParentAppearanceArea.setter
    def ParentAppearanceArea(self, value: str) -> None: ...
    @property
    def SelectionList(self) -> SelectNXObjectList: ...
    @SelectionList.setter
    def SelectionList(self, value: SelectNXObjectList) -> None: ...
