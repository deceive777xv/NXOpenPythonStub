...
class ShapeSearchBuilder(Builder):
    ...
    def CustomShapeSizeLowerLimit(self, value: int) -> None: ...
    @property
    def CustomShapeSizeUpperLimit(self) -> int: ...
    @CustomShapeSizeUpperLimit.setter
    def CustomShapeSizeUpperLimit(self, value: int) -> None: ...
    @property
    def InputBody(self) -> SelectNXObjectList: ...
    @InputBody.setter
    def InputBody(self, value: SelectNXObjectList) -> None: ...
    @property
    ...
    @property
    def SearchShapeSimilarity(self) -> ShapeSearch.ShapeSearchBuilder.ShapeSimilarity: ...
    @SearchShapeSimilarity.setter
    def SearchShapeSimilarity(self, value: ShapeSearch.ShapeSearchBuilder.ShapeSimilarity) -> None: ...
    @property
    def SearchShapeSize(self) -> ShapeSearch.ShapeSearchBuilder.ShapeSize: ...
    @SearchShapeSize.setter
    def SearchShapeSize(self, value: ShapeSearch.ShapeSearchBuilder.ShapeSize) -> None: ...
    @property
    def SearchType(self) -> ShapeSearch.ShapeSearchBuilder.SearchByType: ...
    @SearchType.setter
    def SearchType(self, value: ShapeSearch.ShapeSearchBuilder.SearchByType) -> None: ...
    @property
    def UseCustomShapeSize(self) -> bool: ...
    @UseCustomShapeSize.setter
    def UseCustomShapeSize(self, value: bool) -> None: ...
