...
class ResourceUtilities(System.Object):
    ...
    @property
    def AuthenticodeSignatureSize(self) -> int: ...
    @AuthenticodeSignatureSize.setter
    def AuthenticodeSignatureSize(self, value: int) -> None: ...
...
class PeReader(System.Object):
    ...
    @property
    def SecurityDir(self) -> Utilities.PeReader.IMAGE_DATA_DIRECTORY: ...
    @SecurityDir.setter
    def SecurityDir(self, value: Utilities.PeReader.IMAGE_DATA_DIRECTORY) -> None: ...
    @property
    def HasSecurityDir(self) -> bool: ...
    @HasSecurityDir.setter
    def HasSecurityDir(self, value: bool) -> None: ...
    ...
    class PeReaderIMAGE_OPTIONAL_HEADER64():
        ...
        @property
        def MajorLinkerVersion(self) -> bytes: ...
        @MajorLinkerVersion.setter
        def MajorLinkerVersion(self, value: bytes) -> None: ...
        @property
        def MinorLinkerVersion(self) -> bytes: ...
        @MinorLinkerVersion.setter
        def MinorLinkerVersion(self, value: bytes) -> None: ...
        @property
        def SizeOfCode(self) -> int: ...
        @SizeOfCode.setter
        def SizeOfCode(self, value: int) -> None: ...
        @property
        def SizeOfInitializedData(self) -> int: ...
        @SizeOfInitializedData.setter
        def SizeOfInitializedData(self, value: int) -> None: ...
        @property
        def SizeOfUninitializedData(self) -> int: ...
        @SizeOfUninitializedData.setter
        def SizeOfUninitializedData(self, value: int) -> None: ...
        @property
        ...
        @BaseOfCode.setter
        def BaseOfCode(self, value: int) -> None: ...
        @property
        def ImageBase(self) -> int: ...
        @ImageBase.setter
        def ImageBase(self, value: int) -> None: ...
        @property
        def SectionAlignment(self) -> int: ...
        @SectionAlignment.setter
        def SectionAlignment(self, value: int) -> None: ...
        @property
        def FileAlignment(self) -> int: ...
        @FileAlignment.setter
        def FileAlignment(self, value: int) -> None: ...
        @property
        def MajorOperatingSystemVersion(self) -> int: ...
        @MajorOperatingSystemVersion.setter
        def MajorOperatingSystemVersion(self, value: int) -> None: ...
        @property
        def MinorOperatingSystemVersion(self) -> int: ...
        @MinorOperatingSystemVersion.setter
        def MinorOperatingSystemVersion(self, value: int) -> None: ...
        @property
        def MajorImageVersion(self) -> int: ...
        @MajorImageVersion.setter
        def MajorImageVersion(self, value: int) -> None: ...
        @property
        def MinorImageVersion(self) -> int: ...
        @MinorImageVersion.setter
        def MinorImageVersion(self, value: int) -> None: ...
        @property
        def MajorSubsystemVersion(self) -> int: ...
        @MajorSubsystemVersion.setter
        def MajorSubsystemVersion(self, value: int) -> None: ...
        @property
        def MinorSubsystemVersion(self) -> int: ...
        @MinorSubsystemVersion.setter
        def MinorSubsystemVersion(self, value: int) -> None: ...
        @property
        def Win32VersionValue(self) -> int: ...
        @Win32VersionValue.setter
        def Win32VersionValue(self, value: int) -> None: ...
        @property
        ...
        def SizeOfHeaders(self, value: int) -> None: ...
        @property
        ...
        @DllCharacteristics.setter
        def DllCharacteristics(self, value: int) -> None: ...
        @property
        def SizeOfStackReserve(self) -> int: ...
        @SizeOfStackReserve.setter
        def SizeOfStackReserve(self, value: int) -> None: ...
        @property
        def SizeOfStackCommit(self) -> int: ...
        @SizeOfStackCommit.setter
        def SizeOfStackCommit(self, value: int) -> None: ...
        @property
        def SizeOfHeapReserve(self) -> int: ...
        @SizeOfHeapReserve.setter
        def SizeOfHeapReserve(self, value: int) -> None: ...
        @property
        def SizeOfHeapCommit(self) -> int: ...
        @SizeOfHeapCommit.setter
        def SizeOfHeapCommit(self, value: int) -> None: ...
        @property
        def LoaderFlags(self) -> int: ...
        @LoaderFlags.setter
        def LoaderFlags(self, value: int) -> None: ...
        @property
        def NumberOfRvaAndSizes(self) -> int: ...
        @NumberOfRvaAndSizes.setter
        def NumberOfRvaAndSizes(self, value: int) -> None: ...
        @property
        def DataDirectory(self) -> typing.List[Utilities.PeReader.IMAGE_DATA_DIRECTORY]: ...
        @DataDirectory.setter
        def DataDirectory(self, value: typing.List[Utilities.PeReader.IMAGE_DATA_DIRECTORY]) -> None: ...
    ...
    class PeReaderIMAGE_OPTIONAL_HEADER32():
        ...
        @BaseOfData.setter
        def BaseOfData(self, value: int) -> None: ...
        @property
        def ImageBase(self) -> int: ...
        @ImageBase.setter
        def ImageBase(self, value: int) -> None: ...
    ...
    class PeReaderIMAGE_NT_HEADERS():
        ...
        @property
        def FileHeader(self) -> Utilities.PeReader.IMAGE_FILE_HEADER: ...
        @FileHeader.setter
        def FileHeader(self, value: Utilities.PeReader.IMAGE_FILE_HEADER) -> None: ...
        @property
        def OptionalHeader32(self) -> Utilities.PeReader.IMAGE_OPTIONAL_HEADER32: ...
        @OptionalHeader32.setter
        def OptionalHeader32(self, value: Utilities.PeReader.IMAGE_OPTIONAL_HEADER32) -> None: ...
        @property
        def OptionalHeader64(self) -> Utilities.PeReader.IMAGE_OPTIONAL_HEADER64: ...
        @OptionalHeader64.setter
        def OptionalHeader64(self, value: Utilities.PeReader.IMAGE_OPTIONAL_HEADER64) -> None: ...
    ...
    class PeReaderIMAGE_FILE_HEADER():
        ...
        @PointerToSymbolTable.setter
        def PointerToSymbolTable(self, value: int) -> None: ...
        @property
        def NumberOfSymbols(self) -> int: ...
        @NumberOfSymbols.setter
        def NumberOfSymbols(self, value: int) -> None: ...
        @property
        def SizeOfOptionalHeader(self) -> int: ...
        @SizeOfOptionalHeader.setter
        def SizeOfOptionalHeader(self, value: int) -> None: ...
        @property
        def Characteristics(self) -> int: ...
        @Characteristics.setter
        def Characteristics(self, value: int) -> None: ...
    ...
    class PeReaderIMAGE_DOS_HEADER():
        ...
        @e_magic.setter
        def e_magic(self, value: int) -> None: ...
        @property
        def e_cblp(self) -> int: ...
        @e_cblp.setter
        def e_cblp(self, value: int) -> None: ...
        @property
        def e_cp(self) -> int: ...
        @e_cp.setter
        def e_cp(self, value: int) -> None: ...
        @property
        def e_crlc(self) -> int: ...
        @e_crlc.setter
        def e_crlc(self, value: int) -> None: ...
        @property
        def e_cparhdr(self) -> int: ...
        @e_cparhdr.setter
        def e_cparhdr(self, value: int) -> None: ...
        @property
        def e_minalloc(self) -> int: ...
        @e_minalloc.setter
        def e_minalloc(self, value: int) -> None: ...
        @property
        def e_maxalloc(self) -> int: ...
        @e_maxalloc.setter
        def e_maxalloc(self, value: int) -> None: ...
        @property
        def e_ss(self) -> int: ...
        @e_ss.setter
        def e_ss(self, value: int) -> None: ...
        @property
        def e_sp(self) -> int: ...
        @e_sp.setter
        def e_sp(self, value: int) -> None: ...
        @property
        def e_csum(self) -> int: ...
        @e_csum.setter
        def e_csum(self, value: int) -> None: ...
        @property
        def e_ip(self) -> int: ...
        @e_ip.setter
        def e_ip(self, value: int) -> None: ...
        @property
        def e_cs(self) -> int: ...
        @e_cs.setter
        def e_cs(self, value: int) -> None: ...
        @property
        def e_lfarlc(self) -> int: ...
        @e_lfarlc.setter
        def e_lfarlc(self, value: int) -> None: ...
        @property
        def e_ovno(self) -> int: ...
        @e_ovno.setter
        def e_ovno(self, value: int) -> None: ...
        @property
        def e_res1(self) -> int: ...
        @e_res1.setter
        def e_res1(self, value: int) -> None: ...
        @property
        def e_oemid(self) -> int: ...
        @e_oemid.setter
        def e_oemid(self, value: int) -> None: ...
        @property
        def e_oeminfo(self) -> int: ...
        @e_oeminfo.setter
        def e_oeminfo(self, value: int) -> None: ...
        @property
        def e_res2(self) -> int: ...
        @e_res2.setter
        def e_res2(self, value: int) -> None: ...
        @property
        def e_lfanew(self) -> int: ...
        @e_lfanew.setter
        def e_lfanew(self, value: int) -> None: ...
...
class ObjectMapEntry(System.Object):
    ...
    @property
    def Obj(self) -> TaggedObject: ...
    @Obj.setter
    def Obj(self, value: TaggedObject) -> None: ...
    @property
    def RemainingUndoOverDelete(self) -> int: ...
    @RemainingUndoOverDelete.setter
    def RemainingUndoOverDelete(self, value: int) -> None: ...
    @property
...
class NXRemotingHelper(System.Object):
    def IsSessionRunningRemotely(self, ownerSession: typing.Any) -> bool: ...
    def GetServerObject(self) -> typing.Any: ...
    def __init__(self) -> None: ...
...
class NXRemotableObject(System.MarshalByRefObject):
    ...
    def __init__(self) -> None: ...
    @property
    def NextSink(self) -> typing.Any: ...
    @NextSink.setter
    def NextSink(self, value: typing.Any) -> None: ...
...
class NXObjectManager(Utilities.NXRemotableObject):
    ...
    class __c__DisplayClass19_0(System.Object):
...
class JAM(System.Object):
    ...
    @typing.overload
    def ToTagArray(self, objects: typing.Any) -> typing.List[Tag]: ...
    @typing.overload
    ...
    def ToVariant(self, o: typing.Any) -> Utilities.JAM.Variant: ...
    def FreeVariantArray(self, v: typing.List[Utilities.JAM.Variant]) -> None: ...
    def ToVariantArray(self, objects: typing.Any) -> typing.List[Utilities.JAM.Variant]: ...
    def ToObject(self, v: Utilities.JAM.Variant) -> typing.Any: ...
    @typing.overload
    def ToObjectArray(self, tags: typing.List[Tag]) -> typing.Any: ...
    def ToStructureArray(self) -> None: ...
    @typing.overload
    def ToObjectArray(self, count: int, variants: int) -> typing.Any: ...
    @typing.overload
    ...
    class JAMVariant():
        @property
        def type(self) -> Utilities.JAM.VariantType: ...
        @type.setter
        def type(self, value: Utilities.JAM.VariantType) -> None: ...
        @property
        def array_length(self) -> int: ...
        @array_length.setter
        def array_length(self, value: int) -> None: ...
        @property
        def val(self) -> Utilities.JAM.VariantValue: ...
        @val.setter
        def val(self, value: Utilities.JAM.VariantValue) -> None: ...
...
class DeletedObjectQueue(System.Object):
    ...
    @property
    def Newest(self) -> Utilities.ObjectMapEntry: ...
    @Newest.setter
    def Newest(self, value: Utilities.ObjectMapEntry) -> None: ...


    class Element(System.Object):
...
class CodeDomCompiler(System.Object):
    ...
    def TidyUp(self) -> None: ...
    @property
    def Assembly(self) -> typing.Any: ...
    @Assembly.setter
    def Assembly(self, value: typing.Any) -> None: ...
