...
class SpoolBuilder(Builder):
    ...
    @property
    def Members(self) -> Routing.RouteObjectCollector: ...
    @Members.setter
    def Members(self, value: Routing.RouteObjectCollector) -> None: ...
    @property
    def Name(self) -> str: ...
    @Name.setter
...
class Spool(NXObject):
    ...
    @property
    def ComponentGroup(self) -> Assemblies.ComponentGroup: ...
    @ComponentGroup.setter
    def ComponentGroup(self, value: Assemblies.ComponentGroup) -> None: ...
    @property
    def Description(self) -> str: ...
    @Description.setter
    def Description(self, value: str) -> None: ...
    ...
    @ViewSet.setter
    def ViewSet(self, value: ViewSet) -> None: ...
...
class RoutingManager(Utilities.NXRemotableObject):
    ...
    @property
    def BuilderFactory(self) -> MechanicalRouting.BuilderFactory: ...
    @BuilderFactory.setter
    def BuilderFactory(self, value: MechanicalRouting.BuilderFactory) -> None: ...
    @property
    def ConnectivityService(self) -> MechanicalRouting.ConnectivityService: ...
    @ConnectivityService.setter
    def ConnectivityService(self, value: MechanicalRouting.ConnectivityService) -> None: ...
    @property
    def LogicalDesignService(self) -> MechanicalRouting.LogicalDesignService: ...
    @LogicalDesignService.setter
    def LogicalDesignService(self, value: MechanicalRouting.LogicalDesignService) -> None: ...
    @property
    def RunAssembliesService(self) -> MechanicalRouting.RunAssembliesService: ...
    @RunAssembliesService.setter
    def RunAssembliesService(self, value: MechanicalRouting.RunAssembliesService) -> None: ...
    @property
    def RunsManager(self) -> MechanicalRouting.RunsManager: ...
    @RunsManager.setter
    def RunsManager(self, value: MechanicalRouting.RunsManager) -> None: ...
    @property
    def RunsAssignmentManager(self) -> MechanicalRouting.RunsAssignmentManager: ...
    @RunsAssignmentManager.setter
    def RunsAssignmentManager(self, value: MechanicalRouting.RunsAssignmentManager) -> None: ...
    @property
    def SpoolManager(self) -> MechanicalRouting.SpoolManager: ...
    @SpoolManager.setter
    def SpoolManager(self, value: MechanicalRouting.SpoolManager) -> None: ...
...
class PipingComponentFileBuilder(Builder):
    def __init__(self) -> None: ...
    @property
    def ComponentsCollector(self) -> Routing.RouteObjectCollector: ...
    @ComponentsCollector.setter
    def ComponentsCollector(self, value: Routing.RouteObjectCollector) -> None: ...
    @property
    def PcfFileName(self) -> str: ...
    @PcfFileName.setter
    def PcfFileName(self, value: str) -> None: ...
...
class EditCutElbowBuilder(Builder):
    def __init__(self) -> None: ...
    @property
    def LockCutAngle(self) -> bool: ...
    @LockCutAngle.setter
    def LockCutAngle(self, value: bool) -> None: ...
    @property
    def RouteObjectCollector(self) -> Routing.RouteObjectCollector: ...
    @RouteObjectCollector.setter
    def RouteObjectCollector(self, value: Routing.RouteObjectCollector) -> None: ...
...
class CollectionsManager(Utilities.NXRemotableObject):
    ...
    @property
    def CablewayNearNodes(self) -> MechanicalRouting.CablewayNearNodeCollection: ...
    @CablewayNearNodes.setter
    def CablewayNearNodes(self, value: MechanicalRouting.CablewayNearNodeCollection) -> None: ...
    @property
    def Spools(self) -> MechanicalRouting.SpoolCollection: ...
    @Spools.setter
    def Spools(self, value: MechanicalRouting.SpoolCollection) -> None: ...
...
class CablewayNodeIdentifierBuilder(Builder):
    ...
    @property
    def NodeSelection(self) -> Routing.RouteObjectCollector: ...
    @NodeSelection.setter
    def NodeSelection(self, value: Routing.RouteObjectCollector) -> None: ...
...
class CablewayNearNodeBuilder(Builder):
    ...
    @property
    def DeviceComponent(self) -> Assemblies.Component: ...
    @DeviceComponent.setter
    def DeviceComponent(self, value: Assemblies.Component) -> None: ...
    @property
    def DeviceSelection(self) -> SelectNXObjectList: ...
    @DeviceSelection.setter
    def DeviceSelection(self, value: SelectNXObjectList) -> None: ...
    @property
    def Multiport(self) -> Routing.MultiPort: ...
    @Multiport.setter
    def Multiport(self, value: Routing.MultiPort) -> None: ...
    @property
    def NodeSelection(self) -> SelectNXObjectList: ...
    @NodeSelection.setter
    def NodeSelection(self, value: SelectNXObjectList) -> None: ...
...
class CablewayNearNode(NXObject):
    ...
    def SetDistances(self, distances: float) -> None: ...
    @property
    def Device(self) -> Assemblies.Component: ...
    @Device.setter
    def Device(self, value: Assemblies.Component) -> None: ...
    @property
    def Multiport(self) -> Routing.MultiPort: ...
    @Multiport.setter
    def Multiport(self, value: Routing.MultiPort) -> None: ...
...
class CablewayExportBuilder(Builder):
    ...
    @property
    def ExportType(self) -> MechanicalRouting.CablewayExportBuilder.ExportMode: ...
    @ExportType.setter
    def ExportType(self, value: MechanicalRouting.CablewayExportBuilder.ExportMode) -> None: ...
...
class CablewayAttributeBuilder(Builder):
    ...
    @property
    def AttributeCatalog(self) -> MechanicalRouting.CablewayAttributeBuilder.AttributeCatalogType: ...
    @AttributeCatalog.setter
    def AttributeCatalog(self, value: MechanicalRouting.CablewayAttributeBuilder.AttributeCatalogType) -> None: ...
    @property
    def SelectedObjectList(self) -> SelectNXObjectList: ...
    @SelectedObjectList.setter
    def SelectedObjectList(self, value: SelectNXObjectList) -> None: ...
