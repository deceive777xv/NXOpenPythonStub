...
- `examples/select_component_and_body_journal_identifier.py`: opens a Block Styler `SelectObject` dialog for one body occurrence, then reports the owning component JournalIdentifier together with the body JournalIdentifier to use inside that component.
