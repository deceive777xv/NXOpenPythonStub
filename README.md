...
- `examples/component_body_spatial_matrix.py`: collects per-body area, mass, centroid, bounding-box data for each component and builds a tuple-indexed 3D spatial matrix such as `matrix[0, 1, 1]`, with automatic grid sizing derived from the body data.
